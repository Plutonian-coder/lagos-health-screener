    ...
    for (let i = 0; i < 60; i++) {
        if (i % 5 === 0) {
            ...
            hourMarks.push(
                <div
                    key={`num-${i}`}
                    className="pointer-events-none absolute h-[20px] w-[30px] text-center leading-[20px] select-none text-white"
                    style={{
                        left: `${left}px`,
                        top: `${top}px`,
                        fontSize: "16px",
                ...
                <div className="transform-style-preserve-3d group pointer-events-none relative z-10 rounded-full bg-transparent transition-all duration-400 ease-[cubic-bezier(0.25,1,0.5,1)] will-change-transform backface-hidden perspective-[1000px]">
                    ...
                    >
                        ...
                        <div className="absolute top-[80px] left-1/2 z-10 -translate-x-1/2">
                            <span className="text-white/80 text-xs tracking-widest font-bold">ExpressCare</span>
                        </div>
                        <div className="text-white/60 pointer-events-none absolute bottom-[115px] left-[105px] z-10 h-auto w-[140px] text-center text-xs leading-none font-semibold select-none">
                            {dateDisplay}
                        </div>
                        <div className="text-white/60 pointer-events-none absolute bottom-[90px] left-[105px] z-10 h-auto w-[140px] text-center text-xs leading-none select-none">
                            {timeZone}
                        </div>
                    </div>
                </div>
