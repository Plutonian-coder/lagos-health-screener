            ...
            >
                ...
                <div className="flex items-end gap-2">
                    ...
                    <PromptInputActions>
                        ...
                        <PromptInputAction tooltip="Canvas mode">
                            <Button
                                variant="ghost"
                                size="icon"
                        ...
                        <Button
                            ...
                            className="bg-white hover:bg-white/80 text-black disabled:opacity-50"
                        >
                            {isLoading ? (
